...
def show_tables():
	...
	if request.method == 'GET':
		...
		return render_template('indext.html',allfields1=allfields1,subarealist=subarealist,bzrules1=[dfrows.to_html()])
...
def postfields():
	...
	elif search_key in ["CONTRACTREFERENCE","COUNTERPARTYNEW","COUNTERPARTYNEWDESC","PDNEW","RWA","LGD","EAD","OUTSTANDING","ACRUED_INTEREST","BALANCE_SHEET_AMOUNT","INCORPORATIONCOUNTRY_NEW,SCURT_PROD_CD","KMATURITY"]:
	...
	if request.method == 'GET':
		...
		return render_template('indext.html',allfields=allfields,rules=dfrows[['Rule','Rule_Type']].to_html(header=False),all_counts=dtrows,search_key=search_key)
